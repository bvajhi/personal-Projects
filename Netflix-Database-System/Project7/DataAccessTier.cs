...
namespace DataAccessTier
{
  ...
  public class Data
  {
    ...
    public object ExecuteScalarQuery(string sql)
    {
            ...
            // listBox1.Items.Add("Connection Succesfull");
         

            SqlConnection db = new SqlConnection(_DBConnectionInfo);
            db.Open();
            object result;
            //Now inset the values in the table
    ...
    public DataSet ExecuteNonScalarQuery(string sql)
    {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter(sql, _DBConnectionInfo);
            //get the result as a dataset...
